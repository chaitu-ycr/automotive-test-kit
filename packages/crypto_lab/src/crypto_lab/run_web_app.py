...
logging.basicConfig(
    level=getattr(logging, os.environ.get("CRYPTO_LAB_LOGLEVEL", "INFO").upper(), logging.INFO),
...
class WebAppLauncher:
    ...
    def parse_args() -> argparse.Namespace:
        ...
        parser = argparse.ArgumentParser(
            description="Launch the crypto_lab Streamlit web application."
        )
        parser.add_argument(
            "--server-address",
            type=str,
        ...
        parser.add_argument(
            ...
            type=int,
            default=8503,
            help="Port for the Streamlit server (default: 8503)"
        )
        return parser.parse_args()

def main():
    """
    Main entry point for launching the crypto_lab Streamlit web application.
